...
const file_models_player_model_proto_rawDesc = "" +
	...
	"\rcorrect_index\x18\x03 \x01(\x03R\fcorrectIndex\x12\x14\n" +
	"\x05level\x18\x04 \x01(\tR\x05levelBLZJgithub.com/Vladislav-Evg-Sid/quizbot/server-player/internal/pb/players_apib\x06proto3"
